...
local CustomTags = {
	...
	[754232813] = { TagText = "OG Shiroyasha", Color = Gradient1 = Color3.fromRGB(255, 0, 0), Gradient2 = Color3.fromRGB(0, 255, 0), Gradient3 = Color3.fromRGB(0, 0, 255) },
}
...
local TagEffectProfiles = {
	...
	[754232813] = { Effects = { "Pulse" }, Gradient1 = Color3.fromRGB(255, 0, 0), Gradient2 = Color3.fromRGB(0, 255, 0), Gradient3 = Color3.fromRGB(0, 0, 255),}
}
